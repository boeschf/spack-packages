...
class NvidiaMathdx(Package):
    """NVIDIA MathDX: device-side math libraries (cuBLASDx, cuFFTDx, cuRANDDx, cuSolverDx, nvCOMPDx)."""
    ...
    variant("internal-cutlass", default=False, description="Install vendored/internal cutlass")

    depends_on("cutlass@3.9.0:", when="~internal-cutlass")
...
"""
    ...
    def setup_dependent_build_environment(self, env, dependent_spec):
        ...
        if "~internal-cutlass" in self.spec:
